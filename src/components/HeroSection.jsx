                ...
                <div className="space-y-6">
                    <h1 className="text-4xl md:text-6xl font-bold tracking-tight ">
                        ...
                        <span className="opacity-0 animate-fade-in-delay-1"> I'm</span>
                         <span className="text-primary opacity-0 animate-fade-in-delay-2"> Shivam</span>
                          
                    </h1>
                    <p className="text-lg md:text-xl text-muted-foreground max-2-2xl max-auto opacity-0 animate-fade-in-delay-3">
                     a passionate Computer Science student and developer with a focus on building clean,
